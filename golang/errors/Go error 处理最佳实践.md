...
**在我看来 go 的痛点不是缺少泛型，不是 error 太挫，而是 GC 太弱，尤其对大内存非常不友好**，这方面可以参考真实环境下[大内存 Go 服务性能优化一例](https://mp.weixin.qq.com/s/jGGCccMOx4s5asG2IXWNMQ)
当前 error 的问题有两点：
...
当然现在新增加了 net.Error 类型，实现了 Temporary 接口，不过也要废弃了，请参考#45729
