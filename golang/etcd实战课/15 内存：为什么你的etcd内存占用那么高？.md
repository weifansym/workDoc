...
![image](https://github.com/user-attachments/assets/e4f1671f-a3de-4237-85e9-1c3e5031593a)
...
![image](https://github.com/user-attachments/assets/a19bb769-3342-4b00-89ad-ab043c5533d7)

![image](https://github.com/user-attachments/assets/f9f5a1e8-68e9-4303-aa24-83f4e5000dda)

你预测执行1000次同样key更新后，etcd进程占用了多少内存呢? 约37M？ 1G？ 2G？3G？ 还是其他呢？

执行1000次的put操作后，db大小和etcd内存占用分别如下图所示。

![image](https://github.com/user-attachments/assets/754c92e5-f036-48f2-b812-92d009dab91f)

![image](https://github.com/user-attachments/assets/b2f88515-4e7a-42a4-a87e-356a1fcb8254)

当我们执行compact、defrag命令后，如下图所示，db大小只有1M左右，但是你会发现etcd进程实际却仍占用了2G左右内存。- 

![image](https://github.com/user-attachments/assets/9bf0b878-77bd-4a87-8fa1-596d7b1379bd)

![image](https://github.com/user-attachments/assets/d85e5faf-ff0b-4aae-91eb-14a27c661be7)
...
![image](https://github.com/user-attachments/assets/af790dde-7528-4661-8052-66396d7d6d14)
...
比如早期etcd clientv3的lease keepalive租约频繁续期bug，它会导致Leader高负载、内存泄露，此bug已在3.2.<sup>24</sup>⁄<sub>3</sub>.3.9版本中修复。
...
![image](https://github.com/user-attachments/assets/1861c9f9-879d-47f1-9f65-cf13c0a0bfcb)
