...
chain_database chain_ 是相对于memory\_pool而言的，chain\_就是已经经过确认，并且在本地持久化存储的区块数据（由于时间有限，Tinychain的案例中还未实现持久化存储，可以后续升级替换）。
...
<img width="1920" height="1345" alt="image" src="https://github.com/user-attachments/assets/5260558f-c396-4c87-a24d-20309d150f99" />


我们可以看到有Tinychain和Cli-tinychain。

<img width="1286" height="280" alt="image" src="https://github.com/user-attachments/assets/c150ca63-6b38-48c2-baaa-38a85654528e" />

Tnychain就是我们的核心程序，cli-tinychain就是我们的命令行客户端。

实际上我在Server里还嵌入了一个可视化的Websocket界面。

<img width="1920" height="1273" alt="image" src="https://github.com/user-attachments/assets/48c9c0b8-80d4-4d6f-8f91-331d7b8ed0ec" />
...
<img width="1572" height="166" alt="image" src="https://github.com/user-attachments/assets/243488d7-8887-482b-8436-d98166b21c68" />
...
我们可以通过这个位置观察难度调整的情况。 
<img width="1858" height="552" alt="image" src="https://github.com/user-attachments/assets/28df3d62-fbfd-415e-aa09-7656d6d0ed8f" />
...
<img width="1676" height="254" alt="image" src="https://github.com/user-attachments/assets/587912f3-c9fe-4df5-ba33-d0df51fc4da1" />

接着发送第一笔交易。

<img width="1666" height="686" alt="image" src="https://github.com/user-attachments/assets/e2b46c83-a6ff-4994-8673-a26bafdce58c" />

探测到接下来被打包到区块中。

<img width="1888" height="1356" alt="image" src="https://github.com/user-attachments/assets/b6a4a0fe-0e90-48c8-8e70-658f2810e02d" />
